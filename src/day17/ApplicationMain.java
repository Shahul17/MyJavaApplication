...
public class ApplicationMain implements Comparable<ApplicationMain> {
Scanner scanner;
ClassTwo cityub;
...
ApplicationMain(String username,String password,String name,String dob,String email,String phone,String hobbies,int age){
	this.username=username;
	this.password=password;
	this.name=name;
	this.dob=dob;
...
void GetDetailsFromUser() {
	...
	/*ApplicationMain reader = new ApplicationMain();
     Character mask = '*';
     String line = null;
    // do {
...
@Override
public int compareTo(ApplicationMain o) {
	// TODO Auto-generated method stub
