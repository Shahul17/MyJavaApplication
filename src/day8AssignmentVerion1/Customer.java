...
public class Customer {
 ...
 int customerid,customer_phonenum,customeraccount;
 String customername;
...
void getCustomerDetailsFromUser() {
	...
	System.out.println("please enter the customer phonenum:"+customer_phonenum);
	customer_phonenum=scanner.nextInt();
	System.out.println("please enter the custome raccount:"+customeraccount);
